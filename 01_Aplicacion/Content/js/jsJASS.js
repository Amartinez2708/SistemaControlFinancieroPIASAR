...
function EditarActividad(Id) {
    ...
    $.get("/JASS/ListDetalleSeguimientoId?Id=" + Id, function (data, status) {
        ...
        $.get("/JASS/ListSeguimientoDetalleArchivoId?IdSeguimiento=" + data.IdSeguimientoActividadesJASS + "&IdDetalleSeguimiento=" + data.IdDetalleSeguimientoActividadesJASS, function (archivo, status) {
            var template = "";
            var Files = "";
...
function Download(filePath, nombre) {
    var url = "/JASS/DownloadAction"; // URL de la acción con JsonResult
    var parametros = {
        filePath: filePath,
        nombre: nombre
    };
