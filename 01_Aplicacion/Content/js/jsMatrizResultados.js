...
function ExportarExcel(tabla, nom) {
    ...
    var style = "<style>.text-center { vertical-align: middle;text-align: center; white-space:pre-wrap; word-wrap:break-word }; br {mso-data-placement:same-cell;}; .table-bordered-black {border:1px solid #333;}; .table-bordered-black td {border: 1px solid #333;}; .table-bordered-black th {border: 1px solid #333;}; .table {width: 100%; max-width: 100%; margin-bottom: 1rem; background-color: transparent;};td{vertical-align: middle; mso-number-format:\@;}</style>";
    ...
    $.get("/MatrizResultados/ListMatrizResumenRE", function (data, status) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].Nivel == 1) {
                ...
                Fila = Fila + '<td style="vertical-align: middle;text-align: center;width:50px;"><strong>A</strong><br /><br />' + formatMoney(data[i].Anio1_A) + '</td>';
                Fila = Fila + '<td style="vertical-align: middle;text-align: center;width:50px;"><strong>P</strong><br /><br />' + formatMoney(data[i].Anio1_P) + '</td>';
                Fila = Fila + '<td style="vertical-align: middle;text-align: center;width:50px;"><strong>A</strong><br /><br />' + formatMoney(data[i].Anio2_A) + '</td>';
                Fila = Fila + '<td style="vertical-align: middle;text-align: center;width:50px;"><strong>P</strong><br /><br />' + formatMoney(data[i].Anio2_P) + '</td>';
                Fila = Fila + '<td style="vertical-align: middle;text-align: center;width:50px;"><strong>A</strong><br /><br />' + formatMoney(data[i].Anio3_A) + '</td>';
                Fila = Fila + '<td style="vertical-align: middle;text-align: center;width:50px;"><strong>P</strong><br /><br />' + formatMoney(data[i].Anio3_P) + '</td>';
                Fila = Fila + '<td style="vertical-align: middle;text-align: center;width:50px;"><strong>A</strong><br /><br />' + formatMoney(data[i].Anio4_A) + '</td>';
                Fila = Fila + '<td style="vertical-align: middle;text-align: center;width:50px;"><strong>P</strong><br /><br />' + formatMoney(data[i].Anio4_P) + '</td>';
                Fila = Fila + '<td style="vertical-align: middle;text-align: center;width:50px;"><strong>A</strong><br /><br />' + formatMoney(data[i].Anio5_A) + '</td>';
                Fila = Fila + '<td style="vertical-align: middle;text-align: center;width:50px;"><strong>P</strong><br /><br />' + formatMoney(data[i].Anio5_P) + '</td>';
                Fila = Fila + '<td style="vertical-align: middle;text-align: center;width:50px;"><strong>A</strong><br /><br />' + formatMoney(data[i].Meta_A) + '</td>';
                Fila = Fila + '<td style="vertical-align: middle;text-align: center;width:50px;"><strong>P</strong><br /><br />' + formatMoney(data[i].Meta_P) + '</td>';
