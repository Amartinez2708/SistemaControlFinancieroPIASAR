...
$(document).ready(function () {
    ...
    function n() {
        $(".theme-color > a.navbar-theme").on("click", function () {
            ...
            $(".pcoded-navbar").attr("navbar-theme", e),
                $(".pcoded").attr("sidebar-img", "false"),
                "themelight1" == e && $(".pcoded-navigation-label").attr("menu-title-theme", "theme1"),
                "theme1" == e && $(".pcoded-navigation-label").attr("menu-title-theme", "theme6");
        });
    }
    function i() {
    ...
    $("#pcoded").pcodedmenu({
        ...
        ActiveItemBackground: "theme10",
        SubItemBackground: "theme2",
        ActiveItemStyle: "style0",
        ItemBorder: !0,
        ItemBorderStyle: "none",
        NavbarImage: "true",
        ActiveNavbarImage: "img5",
        SubItemBorder: !0,
