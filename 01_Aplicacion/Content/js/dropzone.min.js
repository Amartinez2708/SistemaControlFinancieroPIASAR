                    ...
                    addedfile: function (e) {
                        ...
                        if ((this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer && !this.options.disablePreviews)) {
                            ...
                            this.options.addRemoveLinks &&
                                ((e._removeLink = b.createElement('<a class="dz-remove btn-danger btn btn-sm m-t-5" href="javascript:undefined;" data-dz-remove>'.concat(this.options.dictRemoveFile, "</a>"))), e.previewElement.appendChild(e._removeLink));
                            var s,
                                l = function (n) {
                                    return (
                                        n.preventDefault(),
