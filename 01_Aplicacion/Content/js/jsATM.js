...
function EditarActividad(Id) {
    ...
    $.get("/ATM/ListDetalleSeguimientoId?Id=" + Id, function (data, status) {
        ...
        $.get("/ATM/ListSeguimientoDetalleArchivoId?IdSeguimiento=" + data.IdSeguimientoActividadesATM + "&IdDetalleSeguimiento=" + data.IdDetalleSeguimientoActividadesATM, function (archivo, status) {
            var template = "";
            var Files = "";
...
function Download(filePath, nombre) {
    var url = "/ATM/DownloadAction"; // URL de la acción con JsonResult
    var parametros = {
        filePath: filePath,
        nombre: nombre
    };
